...
sns.heatmap(corr, cbar=True, square= True, fmt='.1f', annot=True, annot_kws={'size':35}, cmap='Greens')
# %%
# Spliting target variable and independent variables
df_newTrain = df_train.replace('NaN', 0)
# df_newTrain.dropna()
df_newTrain.isnull().sum()
X = df_newTrain.drop(['date_time','gross_bookings_usd', 'click_bool', 'position', 'booking_bool'], axis = 1)
